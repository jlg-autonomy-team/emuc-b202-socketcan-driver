...
int main (int argc, char *argv[])
{
  ...
  if(ver_info.fw[1] == '3' || ver_info.fw[1] == '4')  // B2S3 (nuvoton)
  {
...
static void print_usage (char *prg)
{
  ...
  fprintf(stderr, "Options: -s <speed>[<speed>] (set CAN speed 0..7)\n");
  fprintf(stderr, "                0: 5    KBPS (support FW version > 03.00)\n");
  fprintf(stderr, "                1: 10   KBPS (support FW version > 03.00)\n");
  fprintf(stderr, "                2: 20   KBPS (support FW version > 03.00)\n");
  fprintf(stderr, "                3: 50   KBPS (support FW version > 03.00)\n");
...
static char *look_up_xmit_delay_b2s3 (int speed)
{
  #define TOTAL_BAUD_SELECT_B2S3 11

  static char xmit_delay_table[TOTAL_BAUD_SELECT_B2S3][6] =
  {
    "28000",    /* 5K */
    "14000",    /* 10K */
    "7000",    /* 20K */
  ...
  return xmit_delay_table[speed];
}

static char *look_up_xmit_delay_b202 (int speed)
{
  #define TOTAL_BAUD_SELECT_B202 7

  static char xmit_delay_table[TOTAL_BAUD_SELECT_B202][5] =
  {
    "500", /* 100K */
    "400", /* 125K */
    "300", /* 250K */
